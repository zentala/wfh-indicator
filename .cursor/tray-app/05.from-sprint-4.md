...
**Priorytet:** WYSOKI - kluczowe funkcjonalności produktu

### Sprint 6: Automatyzacja statusu i powiadomienia "Ask to Enter" - PLANOWANY 🎯

**Cel Sprintu:** Wdrożenie dwóch kluczowych funkcjonalności:
...
*   **User Stories / Tasks:**
    - [ ] **Task 6.1 (PLANOWANY):** Implementacja serwisu harmonogramu - automatyczna zmiana statusu
    - [ ] **Task 6.2 (PLANOWANY):** Logika zarządzania regułami harmonogramu - CRUD operacje
    - [ ] **Task 6.3 (PLANOWANY):** Implementacja powiadomień systemowych - "Ask to Enter"
    - [ ] **Task 6.4 (PLANOWANY):** Przyciski akcji w powiadomieniach - "Yes", "No", "If Urgent"
    - [ ] **Task 6.5 (PLANOWANY):** Kanał IPC dla "Ask to Enter" - komunikacja z urządzeniami
    - [ ] **Task 6.6 (PLANOWANY):** Testy jednostkowe dla serwisu harmonogramu
    - [ ] **Task 6.7 (PLANOWANY):** Test E2E dla "Ask to Enter" - pełny przepływ powiadomień

### Kluczowe komponenty do implementacji:

1. **`src/main/scheduleService.ts`** - serwis automatycznej zmiany statusu
2. **Rozszerzenie `src/main/deviceManager.ts`** - zarządzanie regułami harmonogramu
3. **`src/main/notificationService.ts`** - obsługa powiadomień systemowych
4. **Nowe kanały IPC** - komunikacja "Ask to Enter"

### Szczegółowy plan Sprint 6:
Zobacz dokument: **`06-sprint-6-plan.md`** - kompletny plan implementacji z architekturą, testami i kryteriami sukcesu.

**Gotowe do rozpoczęcia Sprint 6:**
- ✅ Aplikacja stabilna i przetestowana
- ✅ UI ustawień gotowy do integracji z logiką
- ✅ DeviceManager z prawdziwą komunikacją hardware
